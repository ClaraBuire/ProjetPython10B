...
if __name__ == "__main__":  #sert a relier le programme au widget
    import sys
    ...
    ui.setupUi(Form)
    Form.show()
    ui.pushButton_2.clicked.connect(lambda : clear(ui)) #bouton clear
    ui.pushButton.clicked.connect(lambda: cryptage(ui)) #bouton ok
    sys.exit(app.exec_())
